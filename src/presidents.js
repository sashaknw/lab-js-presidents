...
// Iteration 3 | Count Years in Office - reduce(). skip presidents in office.
...
function getAgeAtInauguration(presidents) {
  return presidents.map(president => {
    const inaugurationYear = parseInt(president.tookOffice,10);
    const ageAtInauguration = inaugurationYear - president.birthYear;
    return {
      name: president.name,
